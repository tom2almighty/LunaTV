...
export const VersionPanel: React.FC<VersionPanelProps> = ({
      ...
      <div
        ...
        className={`p-4 rounded-lg border ${isCurrentVersion
          ...
          : isUpdate
            ...
            : 'bg-muted bg-card/60 border-border'
          }`}
      >
        {/* 版本标题 */}
  ...
  const versionPanelContent = (
    <>
      ...
      {/* 版本面板 */}
      <div
        className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl max-h-[90vh] bg-card rounded-xl shadow-xl z-[1001] overflow-hidden'
        onTouchMove={(e) => {
        ...
        <div className='flex items-center justify-between p-3 sm:p-6 border-b border-border'>
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <div className='flex flex-wrap items-center gap-1 sm:gap-2'>
              <span className='px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium bg-primary/20 text-primary rounded-full'>
                v{CURRENT_VERSION}
              </span>
              {hasUpdate && (
          ...
          <button
            onClick={onClose}
            className='w-6 h-6 sm:w-8 sm:h-8 p-1 rounded-full flex items-center justify-center text-muted-foreground hover:bg-muted dark:hover:bg-card transition-colors'
            aria-label='关闭'
          >
        ...
        <div className='p-3 sm:p-6 overflow-y-auto max-h-[calc(95vh-140px)] sm:max-h-[calc(90vh-120px)]'>
          <div className='space-y-3 sm:space-y-6'>
              ...
              <div className='bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-3 sm:p-4'>
                <div className='flex flex-col gap-3'>
                  ...
                  <a
                    ...
                    target='_blank'
                    rel='noopener noreferrer'
                    className='inline-flex items-center justify-center gap-2 px-3 py-2 bg-primary hover:bg-primary/90 text-white text-xs sm:text-sm rounded-lg transition-colors shadow-sm w-full'
                  >
            ...
            <div className='border-b border-border pb-4'>
              <h4 className='text-lg font-semibold text-foreground pb-3 sm:pb-4'>
                变更日志
              </h4>
